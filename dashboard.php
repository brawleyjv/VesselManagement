            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                ...
                <div style="text-align: right;">
                    ...
                    <div>
                        ...
                        <?php endif; ?>
                        <?php if (can_manage_vessels()): ?>
                            <a href="manage_vessels.php" class="btn btn-warning" style="margin-right: 10px;">Manage Vessels</a>
                        <?php endif; ?>
                        <?php if (is_test_admin()): ?>
                            <span style="background: #ff9800; color: white; padding: 5px 10px; border-radius: 3px; margin-right: 10px; font-size: 12px;">TEST ACCOUNT</span>
                        <?php endif; ?>
